...
class Qwen2_5_VLAWQForCausalLM(BaseAWQForCausalLM):
    ...
    @staticmethod
    def get_visual_model(model: "Qwen2_5_VLForConditionalGeneration"):
        return model.visual
    ...
    def get_fcs_ln_group_map():
        return {
            ("attn.qkv", "norm1"),
            ("mlp.gate_proj", "mlp.up_proj", "norm2"),
        }
    ...
    @staticmethod
    def get_position_embeddings_fun(module: "Qwen2_5_VLForConditionalGeneration"):
        def fun(hidden_states, position_ids):
            pass
        pass
    ...
    @staticmethod
    def get_layers_for_scaling(module: "Qwen2_5_VLDecoderLayer", input_feat, module_kwargs):
        layers = []
